  ...
  return (
    <>
      <div className="flex flex-row  md:hidden">
        <div className={`flex flex-col ${index === 0 ? "bg-blue-50" : "bg-white"}  w-[25vw] h-12 justify-center items-center hover:cursor-pointer`} onClick={() => setIndex(0)}>
          <FaHome size={20} color={`${index === 0 ? "#2563eb" : "gray"}`} />
          <div className={`text-sm ${index === 0 ? "text-blue-600" : "text-slate-500"} font-bold`}>Home</div>
        </div>
        <div className={`flex flex-col ${index === 1 ? "bg-blue-50" : "bg-white"}  w-[25vw] h-12 justify-center items-center hover:cursor-pointer`} onClick={() => setIndex(1)}>
        ...
        <div className={`flex flex-col ${index === 2 ? "bg-blue-50" : "bg-white"}  w-[25vw] h-12 justify-center items-center hover:cursor-pointer`} onClick={() => setIndex(2)}>
        ...
        <div className={`flex flex-col ${index === 3 ? "bg-blue-50" : "bg-white"}  w-[25vw] h-12 justify-center items-center hover:cursor-pointer`} onClick={() => setIndex(3)}>
