import { useState, useContext, useEffect, useRef, ChangeEvent, FC } from "react";
...
export default function SearchBar(){
    ...
    const list = [
        {
          id: 0,
          title: "Diabetics",
          description: "Diabetes is a chronic (long-lasting) health condition that affects how your body turns food into energy. Your body breaks down most of the food you eat into sugar (glucose) and releases it into your bloodstream. When your blood sugar goes up, it signals your pancreas to release insulin.",
        ...
        },
        {
          id: 3,
          title: "Stroke",
          description: "A stroke is a serious, life-threatening medical condition that occurs when the blood supply to part of the brain is cut off. Symptoms of a stroke include weakness, numbness, and difficulty speaking or understanding speech.",
          author: "Jane Doe",
          commentCount: 4,
          upvote: 12,
          createdAt: new Date().getTime(),
    ...
    return (
        <div>
            ...
            />
            <div ref={ulRef} className="search-scrollbar absolute flex flex-col max-h-[400px] w-[430px] overflow-y-scroll overflow-x-hidden rounded-md bg-gray-100">
                {
                    searchList.map((d) => {
...
const SearchCard : FC<ISearchCardProps> = ({
    title, description, author, commentCount, likes
}) => {
    return (
